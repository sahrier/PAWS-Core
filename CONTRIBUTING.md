Contributing to PAWS Core
============================

The PAWS Core project operates an open contributor model where anyone is
...
The following applies to code changes to the PAWS Core project, and is not to be
confused with overall PAWS Network Protocol consensus changes.

Whether a pull request is merged into PAWS Core rests with the project merge
...
Patches that change PAWS consensus rules are considerably more involved than
...
Where a patch set proposes to change the PAWS consensus, it must have been
...
The project leader is the release manager for each PAWS Core release.
