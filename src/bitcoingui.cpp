                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("PAWS Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a PAWS address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and PAWS: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zPAWS"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About PAWS Core"), this);
    aboutAction->setStatusTip(tr("Show information about PAWS Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for PAWS"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your PAWS addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified PAWS addresses"));
    ...
    openAction->setStatusTip(tr("Open a PAWS: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the PAWS Core help message to get a list with possible PAWS command-line options"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to PAWS network", "", count));
}
