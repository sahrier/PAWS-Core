...
public:
    ...
    void setZPAWSControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzPAWS_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzPAWS_clicked();
    void on_pushButtonZPAWSControl_clicked();
