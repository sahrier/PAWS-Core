...
Value getinfo(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total paws balance of the wallet (excluding zerocoins)\n"
            ...
            "  \"zPAWSsupply\" :\n"
            "  {\n"
            "     \"1\" : n,            (numeric) supply of 1 zPAWS denomination\n"
            "     \"5\" : n,            (numeric) supply of 5 zPAWS denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 zPAWS denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 zPAWS denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 zPAWS denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 zPAWS denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 zPAWS denomination\n"
            "     \"5000\" : n,         (numeric) supply of 5000 zPAWS denomination\n"
            "     \"total\" : n,        (numeric) The total supply of all zPAWS denominations\n"
            "  }\n"
    ...
    for (auto denom : libzerocoin::zerocoinDenomList) {
        zpawsObj.push_back(Pair(to_string(denom), ValueFromAmount(chainActive.Tip()->mapZerocoinSupply.at(denom) * (denom*COIN))));
    }
    zpawsObj.emplace_back(Pair("total", ValueFromAmount(chainActive.Tip()->GetZerocoinSupply())));
    obj.emplace_back(Pair("zPAWSsupply", zpawsObj));
