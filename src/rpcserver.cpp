...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* PAWS features */
        {"paws", "masternode", &masternode, true, true, false},
        {"paws", "listmasternodes", &listmasternodes, true, true, false},
        {"paws", "getmasternodecount", &getmasternodecount, true, true, false},
        {"paws", "masternodeconnect", &masternodeconnect, true, true, false},
        {"paws", "masternodecurrent", &masternodecurrent, true, true, false},
        {"paws", "masternodedebug", &masternodedebug, true, true, false},
        {"paws", "startmasternode", &startmasternode, true, true, false},
        {"paws", "createmasternodekey", &createmasternodekey, true, true, false},
        {"paws", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"paws", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"paws", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"paws", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"paws", "getmasternodescores", &getmasternodescores, true, true, false},
        {"paws", "mnbudget", &mnbudget, true, true, false},
        {"paws", "preparebudget", &preparebudget, true, true, false},
        {"paws", "submitbudget", &submitbudget, true, true, false},
        {"paws", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"paws", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"paws", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"paws", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"paws", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"paws", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"paws", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"paws", "checkbudgets", &checkbudgets, true, true, false},
        {"paws", "mnsync", &mnsync, true, true, false},
        {"paws", "spork", &spork, true, true, false},
        {"paws", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"paws", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use pawsd, or the -server option to paws-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:34121/\n";
}
